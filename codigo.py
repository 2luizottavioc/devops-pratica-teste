...
# Lista com os valores de vendas realizadas em cada semana do mês vendas_mensais = [1000, 2000, 3000]
...
def gerar_relatorio():
  total = calcular_total_vendas (vendas_mensais) # Chama a função para calcular o total print("Relatório de vendas - Março")
